...
namespace Pong
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void Initialize()
        {
            ...
            PaddleTop.Y = 0;
            Ball = new Ball(GameConstants.DefaultBallSize, GameConstants.DefaultInitialBallSpeed, GameConstants.DefaultBallBumpSpeedIncreaseFactor, GameConstants.InitialMaximumBallSpeed)
            {
